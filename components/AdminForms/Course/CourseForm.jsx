    ...
    <form onSubmit={handleSubmit(onSubmit)} className="form">
        <div className="form-container">
            ...
            error={errors?.name?.message} >
                ...
                })}  className="form__input" placeholder="Bachelors in AI and DS"/>
            </FormField>
            ...
            error = {errors?.fees?.message}>
                ...
                })} className="form__input" placeholder="70,000"/>
            </FormField>
            ...
            error={errors?.duration?.message} >
                ...
                })}  className="form__input" placeholder="4 years"/>
            </FormField>

             <FormField label={"Total Seats"} 
            icon={User}
            error={errors?.total_seats?.message} >
                <input {...register("total_seats",{
                    required : "Total seats is required" 
                })}  className="form__input" placeholder="120"/>
            </FormField>
