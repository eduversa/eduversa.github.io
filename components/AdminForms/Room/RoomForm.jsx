  ...
  return <>
       <form onSubmit={handleSubmit(onSubmit)} className="form">
              <div className="form-container">
                <h3 className="form__title">{currentData ? "Edit Room" : "Create New Room"}</h3>
                ...
                >
                  ...
                  />
                    ...
                    <Building2 size={16} />
                      ...
                      {errors.building?.message && <p className="form__error">{errors.building.message}</p>}
                    </div>
                    ...
                    <BookOpen size={16} />
                      ...
                      {errors.type?.message && <p className="form__error">{errors.type.message}</p>}
                    </div>
                ...
                >
                  ...
                  />
                    ...
                    <FormField label={"Room Capacity"} icon={Type} error={errors.capacity?.message}>
                        <input {...register("capacity",{
                            required : "Capacity of room is required",
                        })}
                        className="form__input" placeholder="60/70 members"
                        />
                    </FormField>
