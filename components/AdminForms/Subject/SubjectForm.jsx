...
export default function SubjectForm({ onSubmit, onCancel, dropDownData,currentData }) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="form">
      <div className="form-container">
        <h3 className="form__title">{currentData ? "Edit Subject" :"Add New Subject"}</h3>
        ...
        <div className="form__group">
          ...
          {errors.course?.message && (
            <p className="form__error">{errors.course.message}</p>
          )}
        </div>
        ...
        <div className="form__group">
          ...
          {errors.stream?.message && (
            <p className="form__error">{errors.stream.message}</p>
          )}
        </div>
        ...
        <div className="form__actions">
          ...
          >
            {currentData ? "Confirm edit" : "Create subject"}
